...
class AudioRecorderRX11Armed:
    ...
    def create_gui(self):
        ...
        file_frame.grid(row=7, column=0, columnspan=2, sticky=(tk.W, tk.E), pady=5)
        ...
        info_frame.grid(row=8, column=0, columnspan=2, pady=10)
    ...
    def start_input_monitoring(self):
        ...
        try:
            ...
            messagebox.showerror("Error", f"Failed to start input monitoring: {str(e)}")
    ...
    def start_output_monitoring(self):
        ...
        if self.output_device_index is None:
            messagebox.showerror("Error", "No output device selected")
            self.is_armed = False
        ...
        try:
            ...
            print("Output monitoring started (armed)")
        except Exception as e:
            messagebox.showerror("Error", f"Failed to start output monitoring: {str(e)}")
            self.is_armed = False
            self.arm_var.set(False)
